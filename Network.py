...
def test_net_hl():
    ...
    pp.create_load(net, b4, p_mw=100+np.random.normal(0, 0.1), q_mvar=40+np.random.normal(0, 0.06), name='load1')
    pp.create_load(net, b6, p_mw=132+np.random.normal(0, 0.05), q_mvar=60+np.random.normal(0, 0.1), name='load2')
    pp.create_load(net, b8, p_mw=125+np.random.normal(0, 0.05), q_mvar=45+np.random.normal(0, 0.1), name='load3')
...
def test_net_ll():
    ...
    pp.create_load(net, b4, p_mw=80+np.random.normal(0, 0.05), q_mvar=30+np.random.normal(0, 0.1), name='load1')
    pp.create_load(net, b6, p_mw=99+np.random.normal(0, 0.1), q_mvar=50+np.random.normal(0, 0.05), name='load2')
    pp.create_load(net, b8, p_mw=89+np.random.normal(0, 0.05), q_mvar=35+np.random.normal(0, 0.1), name='load3')
